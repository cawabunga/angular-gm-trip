(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["angular-gm-trip"] = factory(require("angular"), require("jQuery"));
	else
		root["angular-gm-trip"] = factory(root["angular"], root["jQuery"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = 'angular-gm-trip';
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(4)(ng);
	__webpack_require__(7)(ng);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = angular.module('angular-gm-trip', []);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Trip = __webpack_require__(5);

	/**
	 * Trip Factory
	 * @constructor
	 */
	var $trip = function $trip(TripFacade) {
	    var defaults = {
	        animation: 'fadeInUp',
	        delay: -1,
	        showNavigation: true,
	     ...
	     */
	    this.$new = function (tripBlocks) {
	        var _options = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];

	        var options = Object.assign({}, defaults, _options);
	        var trip = new Trip(tripBlocks, options);
...
/***/ function(module, exports) {
	...
	var factory = function factory($browser) {
	    /**
	     * @param {Trip} trip
	     * @constructor
	     */
	    var TripFacade = function TripFacade(trip) {
	        this.start = function () {
